...
public class TileSwapper{
    [SerializeField, Range(0.1f, 10f)] float duration = 0.25f;

    [SerializeField, Range(0f, 1f)] float maxDepthOffset = 0.5f;
    Game3Tile tileA, tileB;
    ...
    public float Swap(Game3Tile a, Game3Tile b, bool pingPong){
        tileA = a;
        tileB = b;
